...
const verifyFirebaseToken = async (req, res, next) => {
  ...
  const publicPaths = ['/api/health', '/api/packages', '/api/auth/check-user'];
...
// ============================================================================
// AUTH HELPERS — Pre-authentication endpoints (no Firebase token required)
// ============================================================================

// Check if a user exists by phone number (used during login before auth)
app.post('/api/auth/check-user', async (req, res) => {
  try {
    ...
    const userQuery = await scalability.firestore
      .collection('users')
